...
const HU: Dict = {
  ...
  'Ați folosit un cod de rezervă. Coduri rămase: {n}.': 'Tartalék kódot használt. Hátralévő kódok: {n}.',
  'Reactivați 2FA din pagina Securitate pentru coduri noi.': 'Új kódokért aktiválja újra a 2FA-t a Biztonság oldalon.',
  'Continuă în portal': 'Tovább a portálra',
  'Consemnarea notificării a eșuat.': 'Az értesítés rögzítése nem sikerült.',
...
const EN: Dict = {
  ...
  'Ați folosit un cod de rezervă. Coduri rămase: {n}.': 'You used a recovery code. Codes remaining: {n}.',
  'Reactivați 2FA din pagina Securitate pentru coduri noi.': 'Re-enable 2FA on the Security page to get new codes.',
  'Continuă în portal': 'Continue to the portal',
  'Consemnarea notificării a eșuat.': 'Recording the notification failed.',
